...
if ($property_id === 0) {
    setFlash('error', 'Invalid property ID.');
...
<head>
    ...
    <title>Edit Property | <?= SITE_NAME ?> Admin</title>
...
<div class="admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="admin-page-header">
            <div>
                <h1 class="admin-page-title">Edit Property</h1>
                <p class="admin-page-subtitle">
                    Editing: <?= htmlspecialchars($property['title']) ?>
                </p>
            </div>
        ...
        <form method="POST"
              action="<?= SITE_URL ?>/?page=admin-properties-edit&id=<?= $property_id ?>"
            ...
            <div class="row g-4">
                    ...
                    <div class="admin-form-card">
                        ...
                        <div class="admin-form-group">
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($_POST['title'] ?? $property['title']) ?>"
                                required>
                        </div>
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea
                                ...
                                class="admin-form-control"
                                rows="6"
                                required><?= htmlspecialchars($_POST['description'] ?? $property['description']) ?></textarea>
                        </div>
                        ...
                        <div class="admin-form-group">
                            ...
                            <input
                                ...
                                name="location"
                                class="admin-form-control"
                                value="<?= htmlspecialchars($_POST['location'] ?? $property['location']) ?>"
                                required>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="admin-form-group">
                                    ...
                                    <input
                                        ...
                                        class="admin-form-control"
                                        min="0"
                                        value="<?= htmlspecialchars($_POST['bedrooms'] ?? $property['bedrooms']) ?>"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="admin-form-group">
                                    ...
                                    <input
                                        ...
                                        class="admin-form-control"
                                        min="0"
                                        value="<?= htmlspecialchars($_POST['bathrooms'] ?? $property['bathrooms']) ?>"
                                        required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="admin-form-card mb-4">
                        ...
                        <div class="admin-form-group">
                            ...
                            <select name="listing_type" class="admin-form-control" required>
                                <option value="sale"
                                    <?= ($property['listing_type'] === 'sale') ? 'selected' : '' ?>>
                                    For Sale
                                </option>
                                <option value="rent"
                                    <?= ($property['listing_type'] === 'rent') ? 'selected' : '' ?>>
                                    For Rent
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="admin-form-group">
                            ...
                            <input
                                ...
                                min="0"
                                step="0.01"
                                value="<?= htmlspecialchars($_POST['price'] ?? $property['price']) ?>"
                                required>
                        </div>
                    ...
                    <!-- Submit -->
                    <div class="admin-form-card">
                        <button type="submit" name="update_property" class="btn btn-gold w-100">
                            <i class="bi bi-check-lg me-2"></i>Update Property
                        </button>
