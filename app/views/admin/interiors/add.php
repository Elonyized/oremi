...
<head>
    ...
    <title>Add Interior | <?= SITE_NAME ?> Admin</title>
...
<div class="admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="admin-page-header">
            <div>
                <h1 class="admin-page-title">Add New Interior</h1>
                <p class="admin-page-subtitle">Fill in the details below to add a new interior design</p>
            </div>
        ...
        <form method="POST"
              action="<?= SITE_URL ?>/?page=admin-interiors-add"
            ...
            <div class="row g-4">
                    ...
                    <div class="admin-form-card">
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea
                                ...
                                class="admin-form-control"
                                rows="6"
                                placeholder="Describe the interior design — materials, colors, concept..."
                ...
                <div class="col-lg-4">
                    <div class="admin-form-card mb-4">
                        ...
                        <div class="admin-form-group">
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($_POST['style'] ?? '') ?>">
                    ...
                    <!-- Submit -->
                    <div class="admin-form-card">
                        <button type="submit" name="submit_interior" class="btn btn-gold w-100">
                            <i class="bi bi-check-lg me-2"></i>Save Interior
                        </button>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="admin-form-card">
                        <h5 class="admin-section-title mb-4">
                            <i class="bi bi-images me-2"></i>Interior Images
                        </h5>
                        <p class="admin-form-hint mb-3">
                            Upload high quality photos of the interior design work.
                        </p>
